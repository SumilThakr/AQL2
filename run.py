...
ph_raster      = [(os.path.join(wdir, 'inputs', 'T_PH_H2O.tiff'),1)]
...
clim_raster      = [(os.path.join(wdir,'inputs', 'Beck_KG_V1_present_0p5.tif'),1)]
...
############################################################
# 5         Temperature, moisture & nitrogen fertilization
############################################################
